...
public class SettingsView extends VerticalLayout {
    ...
    public SettingsView(UserSession userSession) {
    ...
    private VerticalLayout createSettings() {
        ...
        saveBtn.addClickListener(event -> {
            ...
            if (user != null) {
                user.setNombre(nameField.getValue());
                userSession.setAuthenticatedUser(user);
                Notification.show("Nombre actualizado correctamente.", 3000, Notification.Position.TOP_CENTER);
    ...
    private VerticalLayout createProfileFields() {
        ...
        if (user != null) {
            fullName = user.getNombre() != null ? user.getNombre() : "";
